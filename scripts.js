...
// let cardArray=document.querySelector('cardArray')
...
function flipCard() {
    ...
    //4. THIS IS THE FLIP. It's saying "Set THIS card in the array with the dynamic id to show its image('src')
